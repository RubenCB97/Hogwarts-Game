...
public class DefensiveCharacterTest {
    ...
    private DefensiveCharacter HarryPotter;
    private DefensiveCharacter RonWeasley;
    ...
    public void setUp() {
        ...
        HarryPotter = new DefensiveCharacter("Harry", "Potter");
        RonWeasley = new DefensiveCharacter("Ron", "Weasley");
    ...
    public void getOffensiveTest() {
        ...
        assertEquals(20.0, HarryPotter.getOffensive(), 0.1);
        assertEquals(20.0, RonWeasley.getOffensive(), 0.1);
    }
    ...
    public void getDefensiveTest() {
        ...
        assertEquals(25.0, HarryPotter.getDefensive(), 0.1);
        assertEquals(25.0, RonWeasley.getDefensive(), 0.1);
    }
    ...
    public void getAttackPointsTest() {
        ...
        HarryPotter.assignWand(HarryW);
        RonWeasley.assignWand(RonW);
        assertEquals(40.0, HarryPotter.getAttackPoints(), 0.1);
        assertEquals(20.0, RonWeasley.getAttackPoints(), 0.1);
    }
    ...
    public void getResistancePointsTest() {
        ...
        HarryPotter.assignWand(HarryW);
        RonWeasley.assignWand(RonW);
        assertEquals(21.0, HarryPotter.getResistancePoints(), 0.1);
        assertEquals(45.5, RonWeasley.getResistancePoints(), 0.1);
    }
    ...
    public void toStringTest() {
        ...
        assertEquals(string1, HarryPotter.toString());
        java.lang.String string2 = RonWeasley.toString();
        assertEquals(string2, RonWeasley.toString());
    }    
}
